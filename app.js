...
var express = require('express')
  ...
  , almsettings = require('./routes/almsettings')
  , almupload = require('./routes/almupload');
...
//almsettings
app.post('/almsettings',auth.auth,almsettings.Post);
app.get('/almsettings',auth.auth,almsettings.Get);

//almupload
app.post('/almupload',auth.auth,almupload.Post);
