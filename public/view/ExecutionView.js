...
Ext.define('Redwood.view.ExecutionView', {
        ...
        this.items = [
            ...
            },
            {
                ...
                items:[
					...
					/*{
                        xtype: "checkbox",
                        fieldLabel: "Upload Results to ALM",
                        itemId:"uploadResultsALM",
                        labelWidth: "125px",
                        anchor:'90%',
                        listeners:{
                            afterrender: function(me,eOpt){
                                Ext.tip.QuickTipManager.register({
                                    target: me.getEl(),
                                    //title: 'My Tooltip',
                                    text: "Upload test results to ALM after run.",
                                    //width: 100,
                                    dismissDelay: 10000 // Hide after 10 seconds hover
                                });
                            },
					...
					{
                        xtype:"textfield",
						fieldLabel: "ALM Test Set Path",
                        allowBlank: true,
                        //labelStyle: "font-weight: bold",
                        itemId:"almTestSetPath",
                        //anchor:'90%',
						width: 400,
						labelWidth: "105px",
                        listeners:{
            ...
            },
			{
                ...
                items:[
					...
					{
                        xtype:"textfield",
						fieldLabel: "ALM Test Set Folder Path",
                        allowBlank: true,
                        //labelStyle: "font-weight: bold",
                        itemId:"almTestSetPath",
                        //anchor:'90%',
    ...
    listeners:{
        afterrender: function(me){
            ...
            if (me.dataRecord != null){
				...
				me.down("#uploadResultsALM").setValue(me.dataRecord.get("uploadResultsALM"));
				me.down("#almTestSetPath").setValue(me.dataRecord.get("almTestSetPath"));
				//me.down("#almTestSet").setValue(me.dataRecord.get("almTestSet"));
    ...
    getExecutionData: function(){
		...
		execution.uploadResultsALM = this.down("#uploadResultsALM").getValue();
		execution.almTestSetPath = this.down("#almTestSetPath").getValue();
		//execution.almTestSet = this.down("#almTestSet").getValue();
